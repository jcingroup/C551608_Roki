...
namespace ProductCategoryL2 {
    ...
    interface FormState<G, F> extends BaseDefine.GirdFormStateBase<G, F> {
        ...
        options_category?: Array<server.Product_Category_L1>
    }
    ...
    export class GridForm extends React.Component<BaseDefine.GridFormPropsBase, FormState<Rows, server.Product_Category_L2>>{
        ...
        insertType() {
            ...
            var lang = 'zh-TW'; //def lang value

            CommFunc.jqGet(this.props.apiInitPath, { lang: lang })
                .done((data_lang, textStatus, jqXHRdata) => {
                    this.setState({
                        edit_type: 1,
                        options_category: data_lang,
                        fieldData: {
                            i_Hide: false,
                            l2_sort: 0,
                            i_Lang: lang,
        ...
        setLangVal(collentName: string, name: string, e: React.SyntheticEvent) {
            ...
            CommFunc.jqGet(this.props.apiInitPath, { lang: input.value })
                .done((data_lang, textStatus, jqXHRdata) => {
                    ...
                    obj['options_category'] = data_lang;
                    obj[collentName][name] = value;
                    obj[collentName]['l1_id'] = '';
